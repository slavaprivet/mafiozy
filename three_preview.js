...
#include <colorspace_fragment>
      ...
      const stopLaserAim=reason=>{laserAimHeld=false;bridge?.setAimHeld?.(false);laserBeam.visible=laserDot.visible=laserHalo.visible=false;laserReticle.style.display='none';renderer.domElement.style.cursor='default';renderer.domElement.dataset.laserAim=`off:${reason||'released'}`;renderer.domElement.dataset.laserBeamLength='0';};
