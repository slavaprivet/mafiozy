...
#include <colorspace_fragment>
      ...
      renderer.domElement.dataset.combatInputProfile='canvas-pointerdown-plus-held-aim-mousedown-chord-v317';
      ...
      if((location.hostname==='127.0.0.1'||location.hostname==='localhost')&&rendererParams.has('previewmousechord'))setTimeout(async()=>{
        ...
        renderer.domElement.dispatchEvent(new MouseEvent('mousedown',{bubbles:true,cancelable:true,button:0,buttons:1,clientX,clientY}));
        ...
        renderer.domElement.dataset.mouseChordQa=JSON.stringify({weapon:currentWeaponId,before,after});
      },2200);
      function shoot(now){
      ...
      const animate = t => {
        ...
        if(dynamic){
          ...
          let crawlingNpcCount=0,limpingNpcCount=0,reactingNpcCount=0,bleedingNpcCount=0,panickingNpcCount=0,coweringNpcCount=0,surrenderingNpcCount=0,helpingNpcCount=0,socialNpcCount=0,alertedNpcCount=0,ambientNpcCount=0,firingPoliceCount=0,walkingArmNpcCount=0;
