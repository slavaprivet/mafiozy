...
#include <colorspace_fragment>
      ...
      const leftLeg=new THREE.Mesh(new THREE.BoxGeometry(.55,1.7,.62),playerTrouserMat),rightLeg=leftLeg.clone();leftLeg.position.set(-.47,.88,0);rightLeg.position.set(.47,.88,0);leftLeg.castShadow=rightLeg.castShadow=true;player.add(leftLeg,rightLeg);
