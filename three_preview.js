...
#include <colorspace_fragment>
      ...
      const cityDoorFrameMaterial=new THREE.MeshStandardMaterial({color:0x182129,roughness:.3,metalness:.86}),cityDoorStepMaterial=new THREE.MeshStandardMaterial({color:0x394149,roughness:.86}),cityDoorMaterials=new Map(),cityDoorGlowMaterials=new Map();
      ...
      const addAnimatedCityDoor=({x,z,w,d,meta,kind,district,seed=0,main=null})=>{
        ...
        const actor={root,left:leftPivot,right:rightPivot,x:doorX,z:doorZ,open:0,color,side,seed,main};cityDoorActors.push(actor);renderer.domElement.dataset.cityAnimatedDoors=String(cityDoorActors.length);return actor;
      };
