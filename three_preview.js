...
#include <colorspace_fragment>
      ...
      const authoredLandmarkStaticDetails=[];
      ...
      const architecturalHeights={pizza:7,coffee:8,carwash:5.8,barbershop:8,garage:6.4,bar:8.5,club:10,warehouse:7.2,port:7,casino:13,hospital:12,firestation:7.5,junkyard:4.5,police:10,mafia_hq:38,market:8,factory:9,mansion:12,gym:9,job_office:10,blackmarket:8,blackmarket_bellini:9,blackmarket_moretti:9};
      ...
      const decorateApartmentInterior=data=>{
        ...
        renderer.domElement.dataset.apartmentInterior=`furnished-v4:${layoutVariant}:${repair}:${+lvl.safe||0}:${+lvl.weaponRack||0}:${+lvl.cameras||0}`;
        renderer.domElement.dataset.apartmentLayout=`safe-slots:${layoutVariant}:seed-${seed.toString(16)}`;
        return true;
      };
