...
#include <colorspace_fragment>
      ...
      renderer.domElement.dataset.combatInputProfile='canvas-pointerdown-plus-mousedown-chord-v316';
      ...
      addEventListener('mousedown',e=>{if(e.button!==0||!(e.buttons&2)||!laserAimHeld||!isCombatSurfaceEvent(e))return;if(performance.now()-primaryCombatHandledAt<32)return;renderer.domElement.dataset.mouseChordFallbacks=String((+renderer.domElement.dataset.mouseChordFallbacks||0)+1);handlePrimaryCombatDown(e);},true);
      ...
      if((location.hostname==='127.0.0.1'||location.hostname==='localhost')&&rendererParams.has('previewmousechord'))setTimeout(async()=>{
        ...
        renderer.domElement.dispatchEvent(new MouseEvent('mousedown',{bubbles:true,cancelable:true,button:0,buttons:3,clientX,clientY}));
