...
class WorldSim:
    ...
    # на клиенте стоит на (r=20, c=36) — здание северо-востока, а сама точка
    # выхода ставится на ближайшую дорогу (c=34, r=18), это перекрёсток.
    # Тебя убил коп с 0-1 звёздами или конвой — выйдешь у больницы, а не
    # там где умер.
    HOSPITAL_X          = 34.0
    HOSPITAL_Y          = 18.0
