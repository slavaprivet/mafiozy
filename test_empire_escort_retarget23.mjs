...
function fixture(fixed){
 ...
 for(const name of ['_clearNpcRoute','_setNpcRoute','_planNpcRouteTo','_npcAdvanceRoute','_npcBodyPassable','_npcPathPassable','_empireTargetFootprintPassable23','_nearestEmpireWalkPoint','_empireFormationOffset','_cancelEmpireEscortRoute','_planEmpireRouteTo','_processEmpireRoutePlanQueue'])vm.runInContext(fn(name),b);
