...
SRC   = os.path.join(_HERE, "battle_tactical.html")
FILE  = "battle_tactical.html"

print("[1] Reading battle_tactical.html...")
...
pl = {"message": "Add tactical battle system", "content": c}
if sha:
    pl["sha"] = sha
