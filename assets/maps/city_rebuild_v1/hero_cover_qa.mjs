...
export function installCoverQa({document,enabled,sources,bodiesAt,canOccupy,groundHeight,place,toggle,fire,crouch,move,finish,weapons=[],selectWeapon,windowSeat}){
 if(!enabled)return;
 const panel=document.createElement('div');panel.id='cover-qa';panel.style.cssText='position:fixed;top:55px;left:320px;max-width:680px;z-index:46;background:#182b32;padding:8px;display:flex;gap:6px;flex-wrap:wrap';
