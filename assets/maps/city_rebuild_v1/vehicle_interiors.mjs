...
export const VEHICLE_INTERIOR_PROFILES=Object.freeze({
 sedan4:Object.freeze({frontSide:.43,frontZ:-.15,rearZ:-1.15,floorTop:.4,cushionTop:.59,roofBottom:2.08,driverRootY:.22,rearSeats:true,cargo:false}),
...
export const SEDAN_DRIVER_SEAT=Object.freeze({side:.43,front:-.15,y:.22});
