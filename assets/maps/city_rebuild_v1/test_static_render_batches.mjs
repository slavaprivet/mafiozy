...
layerRoot.updateMatrixWorld(true);const layerBatches=createStaticRenderBatches({THREE:T,root:layerRoot,instances:layerGroups,minInstances:3}),layerMeshes=layerRoot.children.filter(node=>node.userData.staticRenderBatch);
