...
export const HERO_POSTURES=Object.freeze({
 stand:Object.freeze({value:0,height:1.90,eyeHeight:1.64,walkSpeed:4.60,runSpeed:7.80,slowWalkSpeed:1.65}),
 crouch:Object.freeze({value:1,height:1.69,eyeHeight:1.40,walkSpeed:1.55,runSpeed:1.55}),
...
export function posturePresentation(state,{running=false,slowWalking=false}={}){
 ...
 const standingSpeed=slowWalking?stand.slowWalkSpeed:running?stand.runSpeed:stand.walkSpeed;
 const speed=(standingSpeed*(1-crouch)+crouchSpec.walkSpeed*crouch)*(1-prone)+proneSpec.walkSpeed*prone;
