...
export function createInteriorStaircase(THREE,options){
 const plan=planInteriorStaircase(options),group=new THREE.Group(),ownedInstances=[];group.name='Interior_U_Staircase';
