...
export function createSurfaceMotion(options={}){
 ...
 function canMove(from,to,sample){
  const distance=Math.hypot(to.x-from.x,to.z-from.z),steps=Math.max(1,Math.ceil(distance/probeSpacing));let previous=floorAt(sample,from.x,from.z);
