...
export function createFittedStaircase(THREE,{rect,floorHeight=3.3,baseY=0,flightWidth=1.3,corner='back'}={}){
 ...
 const possibilities=[{rotated:false,rect:rect.slice()},{rotated:true,rect:[-rect[3],rect[0],-rect[1],rect[2]]}];
 ...
 const origin={x:(fit.rect[0]+fit.rect[2]-requiredWidth)/2,z:corner==='front'?fit.rect[3]-margin-depth:fit.rect[1]+margin};
