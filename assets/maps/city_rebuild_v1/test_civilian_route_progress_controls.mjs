...
const report={passed:true,initialWaypointConsumedWithoutDistance:true,indexSequence:indices,travelledM:distances.at(-1),arrivalPhase:'parked',trafficSignalWaitAndResume:true,pedestrianCrossingWaitAndResume:true,yieldWaitAndResume:true,permissionCost:{p50Ms:samples[10],p95Ms:samples[19]},limits:'Actual civilian source TickCar/RoadPermission with controlled canonical road-rule replies; full authored parking, async lane worker, 895.97 m trip and physical building arrival are covered by test_native_parking_lifecycle --long --async.'};
