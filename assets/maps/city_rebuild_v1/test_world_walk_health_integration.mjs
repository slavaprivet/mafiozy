...
const clearBlast=createBlastResponse(THREE,clearScene,{getHero:()=>clearHero,getVehicles:()=>clearVehicles,getRoots:()=>[clearRoots],getGlass:()=>({}),groundHeight:()=>0,onHeroLaunch(){},onHeroExposure:(_,exposure)=>{clearExposure=exposure}});
