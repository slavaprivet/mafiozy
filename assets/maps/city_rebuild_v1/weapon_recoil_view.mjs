...
export function createWeaponRecoilView(THREE){
 ...
 return (renderer,scene,camera,recoil)=>{
  ...
  if(kick===0&&yaw===0){renderer.render(scene,camera);return}
  saved.copy(camera.quaternion);
  try{camera.rotateX(kick);camera.rotateY(yaw);renderer.render(scene,camera)}
